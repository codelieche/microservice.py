...
class LoggingViewSetMixin:
    ...
    # 日志开关：总的开关，如果为False就表示不执行中间件
    modellog_toggle = True

    # 查看对象日志开关
    retrieve_log_toggle = False
    ...
    def retrieve(self, request, *args, **kwargs):
        ...
        if self.modellog_toggle and self.retrieve_log_toggle:
            # 第1步：获取信息
            # 发起请求的用户
