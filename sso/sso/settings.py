...
SECRET_KEY = 'e+(qpq2y9=bpi=040p^ot0k-3=m7_g+gzfe0)t9k6wrcx89g1l'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.environ.get('SSO_DEVELOP_DB', 'sso_develop2'),
...
SIMPLE_JWT = {
    ...
    'SIGNING_KEY': "THIIS IS SSO JWT SECRET KEY:Change Me",
